...
{ claim := { problem := Meanders.Problem.closed, n := 2, count := 2 },
...
/-- A concrete closed count from exact sector evidence, kernel replayed. -/
theorem first_crossing_closed_n2 : closedMeanderNumber 2 = 2 :=
